...
-->
<html lang="en">
 @include('studentInclude.head')
    <body id="page-top">
        <!-- Begin Preloader -->
        <div id="preloader">
            <div class="canvas">
                <img src="{{asset('student/assets/img/logo.png')}}" alt="logo" class="loader-logo">
        ...
        <div class="page">
            <!-- Begin Header -->
            @include('studentInclude.header')
            <!-- End Header -->
            <!-- Begin Page Content -->
            <div class="page-content d-flex align-items-stretch">
                <div class="default-sidebar">
                  @include('studentInclude.navbar')
                    <!-- End Side Navbar -->
                </div>
                <!-- End Left Sidebar -->
